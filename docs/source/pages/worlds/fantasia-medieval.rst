...
.. csv-table::
   ...
   "11", "**APOTECARIO**: Delantal grueso, Mortero pesado, Kit de viales, Destilador, Antídoto."
   "12", "**ARQUERO**: Jubón de cuero, Arco corto, Carcaj con flechas, Cuerda de repuesto, Navaja."
   "13", "**ARTESANO**: Ropa reforzada, Cincel largo, Herramientas de mano, Lija, Bocetos."
   "14", "**ARTISTA**: Capa de terciopelo, Estilete de pintura, Caballete portátil, Lienzos, Carbonilla."
   "15", "**JUGLAR**: Traje vistoso, Daga oculta, Laúd, Maquillaje, Cascabeles."
   "16", "**BARRISTER**: Toga formal, Maza ceremonial, Pergaminos legales, Tinta, Lacre de cera."
   "21", "**MENDIGO**: Harapos remendados, Garrote tosco, Escudilla de madera, Manta rota, Amuleto."
   "22", "**HERRERO**: Mandil de cuero afelpado, Martillo de forja, Tenazas, Carbón, Piedra de afilar."
   "23", "**CARPINTERO**: Ropa de trabajo ruda, Serrucho de mano, Caja de clavos, Formón, Escuadra."
   "24", "**CARTÓGRAFO**: Guantes de cuero fino, Compás afilado, Mapas en blanco, Anteojo, Estuche de cuero."
   "25", "**COCINERO**: Chaqueta de lona, Cuchillo de carnicero, Sartén de hierro, Especias, Paño."
   "26", "**DRAGOMÁN**: Turbante o túnica viajera, Cimitarra ligera, Diario de notas, Mapas, Salvoconducto."
   "31", "**GRANJERO**: Camisa de lino grueso, Guadaña, Saco de semillas, Azada, Cuerda de cáñamo."
   "32", "**PESCADOR**: Botas altas impermeables, Arpón, Red de pesca, Anzuelos, Salazón."
   "33", "**APOSTADOR**: Chaleco con bolsillos, Daga de bota, Dados cargados, Naipes, Moneda falsa."
   "34", "**PALAFRENERO**: Chaleco de cuero rústico, Horca de establo, Cepillo, Soga de doma, Terrones de azúcar."
   "35", "**CURANDERO**: Ropa limpia de lino, Escalpelo, Vendas de gasa, Alcohol, Hilo y aguja médica."
   "36", "**HERBORISTA**: Poncho con capucha, Hoz de recolección, Bolsa de hierbas, Hilo, Tijeras de podar."
   "41", "**JINETE**: Pantalones de montar reforzados, Lanza corta, Silla de montar, Espuelas, Alforjas."
   "42", "**CAZADOR**: Camuflaje de pieles, Arco largo, Trampa para osos, Cuchillo de caza, Cantimplora."
   "43", "**CERRAJERO**: Chaqueta con forro grueso, Ganzúa afilada, Llavero maestro, Lima, Aceitera."
   "44", "**MERCADER**: Abrigo forrado, Daga de adorno, Balanza de mano, Libro de cuentas, Tinta."
   "45", "**MINERO**: Casco de cuero endurecido, Pico, Cantimplora de metal, Linterna de aceite, Carbón."
   "46", "**ACRÓBATA**: Mallas reforzadas, Bastón de equilibrio, Tiza para manos, Cuerda de seda, Lentejuelas."
   "51", "**NOBLE**: Ropa de seda fina, Florete, Sello familiar, Anillo de oro, Perfume."
   "52", "**NÓMADA**: Capa de lana pesada, Arco compuesto, Odre de piel, Yesquero, Brújula primitiva."
   "53", "**SACERDOTE**: Hábito religioso, Bastón con cruz, Símbolo sagrado, Agua bendita, Libro de rezos."
   "54", "**GUARDABOSQUES**: Capa verde oliva, Hacha de mano, Silbato de caza, Trampa pequeña, Raciones."
   "55", "**MARINERO**: Casaca de marinero, Alfanje, Catalejo, Dados de hueso, Frasco de ron."
   "56", "**ERUDITO**: Túnica de una órden, Pluma afilada, Tinta negra, Libro antiguo, Lupa de cristal."
   "61", "**CENTINELA**: Loriga de cuero, Alabarda, Silbato de alerta, Farol, Piedra de afilar."
   "62", "**PASTOR**: Tabardo grueso, Cayado largo, Honda con piedras, Cuchillo de esquilar, Flauta de pan."
   "63", "**TRAFICANTE**: Capa con bolsillos ocultos, Estilete, Ganzúas, Veneno menor, Bolsa oculta."
   "64", "**SASTRE**: Jubón ligero, Tijeras pesadas, Agujas de coser, Carretes de hilo, Cinta métrica."
...
.. rubric:: EQUIPO INICIAL

Los Clérigos comienzan con un Mazo o Estrella del Alba, un Escudo Pavés con el símbolo de su religión, una Cota de malla, una túnica o capa con los colores de su órden, y rosarios o cuentas de oración.

.. rubric:: HABILIDADES ESPECIALES

Los Clérigos tienen acceso a los :ref:`Milagros Divinos <fantasia-medieval-milagros-divinos>`, y también pueden curar con imposición de manos (reducen la severidad de una *Condición* que representa una aflicción física), una cantidad de veces por día iguales a su Nivel de Clérigo.
...
.. csv-table:: Títulos de Clérigo y requisitos para subir de nivel
   ...
   "2", "**HERMANO/A**: Donar una suma considerable de dinero a un monasterio y vivir allí durante un año, cumpliendo votos o juramentos acordes a su religión.", "**PUPILO**: Encontrar y servir a un clérigo veterano, o a un hermitaño seguidor de su religión por un año.", "**FANÁTICO**: Exterminar a un grupo de infieles en un acto de fe y de devoción."
   "3", "**CRUZADO**: Embarcarse en una expedición o viaje para ejecutar o llevar ante la justicia a un líder de un culto sacrílego.", "**CRONISTA**: Viajar a un lugar de importancia sagrada y documentar los eventos que se suceden durante un año.", "**CULTISTA**: Conseguir los materiales u ofrendas prohibidas para un ritual oscuro y ser partícipe de su realización."
   ...
   "5", "**PALADÍN**: Derrotar a una Entidad del Caos, sanear sus dominios sacrílegos y fundar un nuevo templo que albergue a su congregación.", "**PROFETA**: Lograr una hazaña digna de ser notada por un Dios, para luego compartir su palabra con la comunidad.", "**ANTIPALADÍN**: Liderar una guerra sangrienta de revolución que derroque a un régimen religoso de un dios o panteón opositor, estableciendo el reino del caos, consigo a la cabeza."
...
Los Ladrones comienzan con un par de dagas, una túnica o capa con capucha oscuras, unas botas con suela suave, un kit de ganzúas y artilugios para abrir cerraduras y mecanismos, y una soga con gancho. 
...
Los Magos comienzan con una Túnica de mago con gorro o capucha, un Bastón, báculo o cetro adornado, un Libro de hechizos, Una bolsa o morral con componentes e ingredientes mágicos, y un Cristal de enfoque utilizado para potenciar hechizos o rituales. 

.. rubric:: HABILIDADES ESPECIALES

Los Magos tienen acceso a la :ref:`Magia Arcana <fantasia-medieval-magia-arcana>` y a los :ref:`Pactos de Poder <fantasia-medieval-pactos-de-poder>`, y también pueden agregar su Nivel de Mago como modificador a cualquier tirada para resistir o evitar un efecto mágico.
...
Los Guerreros comienzan con una armadura de cota de malla, un Yelmo de acero, una Espada larga o Gran Hacha de Guerra, Un Escudo de cometa, y una Piedra de afilar.
...
Los Enanos comienzan con una armadura de placas, un grueso yelmo de acero, un hacha doble o un gran mazo de guerra, una pica o pala de excavación, y herramientas básicas de reparación.

.. rubric:: HABILIDADES ESPECIALES

Los Enanos tienen acceso a la :ref:`Magia Rúnica <fantasia-medieval-magia-runica>`, y además son muy resistentes; pueden agregar su Nivel de Enano como modificador a cualquier tirada para resistir Condiciones físicas.
...
Los Elfos comienzan con un atuendo ceñido de cuero liviano, una capa verdigris con capucha, un arco corto y un carcaj de 15 flechas, una espada corta curva, y una soga de seda fina pero muy resistente. 

.. rubric:: HABILIDADES ESPECIALES

Los Elfos tienen acceso a la :ref:`Magia Natural <fantasia-medieval-magia-natural>`, y además son muy ágiles; pueden agregar su Nivel de Elfo como modificador a cualquier tirada de Iniciativa o de chequeos de destreza física o precisión.
...
Los Medianos comienzan con ropas livianas como camisas y pantalones de tela, una capa con capucha de tela gruesa, un cayado o bastón de caminar, una honda o cerbatana, y una bolsa donde guardar su pipa y reserva de tabaco.
...
.. csv-table:: Títulos de Mediano y requisitos para subir de nivel
   ...
   "2", "**BUSCADOR**: Embarcarse en una aventura en busca de un objeto particular y encontrarlo."
   "3", "**COLECCIONISTA**: Reunir y preservar cinco objetos raros o valiosos, para agregarlos a su colección."
   "4", "**ACAPARADOR**: Acumular riquezas o posesiones de gran valor que le den fama y atraigan atención indeseada."
...
Si no se elige una Raza particular durante la creación del personaje, se asume que el personaje es Humano. Los humanos no tienen ninguna habilidad especial ni cualidad particular y, por lo tanto, no hace falta tener un "Nivel de Humano" ni anotarlo en la hoja de personaje.
...
.. csv-table::
   ...
   "25", "**ILUSIÓN**: Crea un sonido o una imagen estática que parece real."
   ...
   "41", "**FANTASMAGORIA**: Te vuelve parcialmente incorpóreo para atravesar rejas o cuerdas."
...
.. csv-table::
   ...
   "11", "**RUNA DEL FILO**: El objeto nunca pierde el filo y corta materiales duros más fácil."
   "12", "**RUNA DE LA CORAZA**: El objeto resiste más de lo normal, y absorbe impactos pesados sin abollarse."
   "13", "**RUNA DEL ANCLA**: Impide que el portador o el que esté tocándola sea derribado o movido."
   "14", "**RUNA DEL CANDADO**: Traba un mecanismo contra ganzúas comunes y otros métodos de apertura mundanos."
   "15", "**RUNA DE LA FORJA**: Calienta el objeto al tocarla, hasta ponerse al rojo vivo."
   "16", "**RUNA DEL LAR**: Alerta con un zumbido si cruza el umbral o entra en la zona un extraño."
   "21", "**RUNA DE LA LUZ**: El objeto emite una luz constante como una linterna."
   "22", "**RUNA DE LA CARGA**: Reduce a la mitad el peso aparente de lo que el objeto contenga o sostenga."
   "23", "**RUNA DEL EQUILIBRIO**: El objeto otorga al portador pasos perfectos sobre superficies estrechas o difíciles de cruzar."
   "24", "**RUNA DE LA ALERTA**: El objeto vibra sutilmente cuando un enemigo apunta hacia ti o está por atacarte."
   "25", "**RUNA DEL SILENCIO**: Amortigua completamente los ruidos cercanos al objeto o en esa habitación."
   "26", "**RUNA DE LA SALUD**: Hace al portador del objeto inmune a venenos y enfermedades comunes."
   "31", "**RUNA DEL FUEGO**: Hace que la hoja o cabeza del arma o herramienta se encienda en llamas al desenvainarla."
   "32", "**RUNA DE LA ESCARCHA**: Mantiene los alimentos dentro de un contenedor helados y preservados, o hace que el objeto se hiele y emane frío intenso al empuñarlo para usar."
   "33", "**RUNA DE LA OSCURIDAD**: Mientras la runa esté expuesta al descubierto, el objeto emana una zona de oscuridad total del tamaño de una habitación pequeña."
   "34", "**RUNA DE LA VERDAD**: Cualquiera que se entre en contacto con el objeto no puede mentir."
   "35", "**RUNA DEL VIENTO**: Permite a quien porte el objeto planear distancias cortas al saltar al vacío."
   "36", "**RUNA DEL RETORNO**: El objeto vuela de regreso a la mano tras ser lanzado."
   "41", "**RUNA DE LA MAZA**: Aumenta el impacto de un objeto o arma, permitiendo romper muros de piedra."
   "42", "**RUNA DEL ECO**: Graba las conversaciones cercanas para luego reproducirlas al tocarla."
   "43", "**RUNA DE LA REGENERACIÓN**: Acelera la curación natural mientras se esté en contacto con el objeto."
   "44", "**RUNA DEL ENGAÑO**: Hace que un umbral parezca un muro sólido, ocultando pasajes."
   ...
   "46", "**RUNA DE LA FATIGA**: Duplica el cansancio de quien esté en contacto con el objeto."
   "51", "**RUNA DEL VIGÍA**: Abre un ojo místico en el objeto al tocarla, que el usuario puede vigilar desde otra runa del mismo tipo."
   "52", "**RUNA DE LA CALIDEZ**: Mantiene al portador del objeto cómodo en climas helados."
   "53", "**RUNA DEL PESO**: Vuelve al objeto cinco veces más pesado, o cinco veces más liviano, si se la talla de forma invertida."
   "54", "**RUNA DE LA AGUDEZA**: Permite al portador del objeto ver en la oscuridad absoluta."
   "55", "**RUNA DE LA UNIÓN**: Grabada en dos objetos diferentes; mientras se toca una de las runas, lo que le pase a uno físicamente también le ocurre al otro."
   "56", "**RUNA DEL RASTREO**: Si el objeto puede moverse libremente, apunta siempre hacia la runa gemela."
   "61", "**RUNA DE ELECTROCHOQUE**: El objeto lanza una descarga eléctrica al ser tocado por un rival."
   "62", "**RUNA DE LA ABSORCIÓN**: Si se hace algún tipo de magia en sus cercanías, el hechizo se disminuye o se disipa, y se convierte en energía potencial."
   "63", "**RUNA DEL SUEÑO**: Al portador o a quien esté en contacto con el objeto le garantiza un descanso efectivo y revitalizante, y libre de pesadillas y maleficios."
   "64", "**RUNA DE LA VELOCIDAD**: Permite al portador correr a alta velocidad, o durante distancias largas sin desgastar las piernas."
