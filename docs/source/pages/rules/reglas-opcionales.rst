...
Este es el sistema de Iniciativa predeterminado de *2d6Mundos*, dado que no requiere de tiradas de dados ni mecánicas complejas.
...
Todos los participantes tiran **2d6 ± cualquier Modificador circunstancial o de sus Trasfondos relevantes** para determinar su velocidad de reacción o preparación. Los turnos se suceden en órden descendiente, con los que hayan obtenido resultados más altos actuando primero, y los de resultado más bajo actuando últimos. Cuando todos los participantes hayan tenido su turno, termina el Round. La Iniciativa se vuelve a tirar al comienzo de cada Round.
...
Los Rounds tienen varias "fases" de velocidad. Cada participante debe tirar **2d6 ± cualquier Modificador circunstancial o de sus Trasfondos relevantes** y consultar la siguiente guía para determinar su velocidad:

* **5 o menos**: Actúa solo en la fase *"Lenta"*.
* **6 a 9**: Actúa en las fases "*Normal*" y *"Lenta"*.
* **10 a 12**: Actúa en las fases "*Rápida*", "*Normal*" y *"Lenta"*.
* **13 a 15**: Actúa en las fases "*Super-Rápida*", "*Rápida*", "*Normal*" y *"Lenta"*.
* **16 o más**: Actúa en las fases "*Híper-Rápida*", "*Super-Rápida*", "*Rápida*", "*Normal*" y *"Lenta"*.

Cuando el Round comienza, la acción se resuelve en órden de velocidad descendente, comenzando por la fase "*Híper-Rápida*", luego la "*Super-Rápida*", luego la "*Rápida*", luego la "*Normal*" y finalmente la "*Lenta*" (Si ningún personaje alcanzó una velocidad de alguna fase, se saltea/ignora esa fase y se pasa a la siguiente en la que algún personaje vaya a actuar). En cada fase, los personajes activos **pueden realizar una sola cosa**: atacar a un enemigo, interactuar con un objeto, ayudar a un aliado, moverse a otra zona o a una distancia media, etc. 

Las siguientes son acciones "gratuitas" (no gastan tu acción de una fase de velocidad): 

* Moverse hasta 2 metros.
* Hablar o gritar algo en menos de 2 segundos.

Cuando la última fase "*Lenta*" termina, el Round termina. La Iniciativa se vuelve a tirar al comienzo de cada Round para volver a determinar la velocidad de los participantes.
...
.. _reglas-opcionales-combate-distancia-armadura:
...
* +1 a la Dificultad de la tirada defensiva por cada tirador extra que se suma al primero en dar *Fuego de Cobertura* contra la misma área.
